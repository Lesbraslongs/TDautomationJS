...
let register_new_user_func = require('../../lib/register_new_user');
let login_user_func = require('../../lib/login_with_user');
let open_page_func = require('../../lib/open_page');
let submit_form_func = require('../../lib/submit_form');
let check_elements_func = require('../../lib/check_elements');
let moment = require('moment');
let By = require('selenium-webdriver').By;
let config = require('../../lib/config');
let application_host = config.get_application_host();
let bankholiday_form_id = '#update_bankholiday_form';
let new_bankholiday_form_id= '#add_new_bank_holiday_form';
let new_user_email;
